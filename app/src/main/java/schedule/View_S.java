    ...
    try {
      ...
      while (true) {
        ...
        if (check != true) {
          ...
          continue;}
        msg = "select * from s_seet_"+id+" where s_id ="+number;
        RS = ST.executeQuery(msg);
        ...
        msg = "delete from s_seet_"+id+" where s_id = "+number;
