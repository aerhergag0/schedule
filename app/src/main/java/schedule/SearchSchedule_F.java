...
public class SearchSchedule_F {
  ...
  public void search_f_menu(String id) {
    banner.printbanner1("완료일정 검색");
    searchLoop : while (true) {
      try {
        ...
        switch(menuNum) {
          case 1 : this.search_f_title(id); break;
          case 2 : this.search_f_date(id); break;
          case 3 : this.search_f_contents(id); break;
  ...
  public void search_f_title(String id) {
    ...
    try {
      ...
      if (RS.next() == false) {
        ...
        while (true) {
          ...
          msg = "select * from f_seet_"+id+" where title='"+keyword+"'";
          RS = ST.executeQuery(msg);
          RS.last();
          ...
          if(searchResultCount == 0) {
            ...
            showtable.searchResultShowTable_F(id, "select rownum, a.f_date, a.title, a.contents, a.f_id from (select * from f_seet_"+id+" order by f_date) a where title = '"+keyword+"'");
          }
        }
      }
  ...
  public void search_f_date(String id) {
      ...
      if (RS.next() == false) {
        ...
        while (true) {
          ...
          if (keyword.equals("0")) {return;}
            ...
            msg = "select * from f_seet_"+id+" where f_date='"+keyword+"'";
            RS = ST.executeQuery(msg);
            RS.last();
            int searchResultCount = RS.getRow();
            RS.beforeFirst();
            if(searchResultCount == 0) {
              ...
              showtable.searchResultShowTable_F(id, "select rownum, a.f_date, a.title, a.contents, a.f_id from (select * from f_seet_"+id+" order by f_date) a where f_date = '"+keyword+"'");
            }
          }
        }
      }
  ...
  public void search_f_contents(String id) {
    ...
    try {
      ...
      if (RS.next() == false) {
        ...
        while (true) {
          ...
          String keyword = sc.nextLine();
          if (keyword.equals("0")) {return;}
          msg = "select * from f_seet_"+id+" where contents Like '%"+keyword+"%'";
          RS = ST.executeQuery(msg);
          RS.last();
          int searchResultCount = RS.getRow();
          RS.beforeFirst();
          if(searchResultCount == 0) {
            ...
            showtable.searchResultShowTable_F(id, "select rownum, a.f_date, a.title, a.contents, a.f_id from (select * from f_seet_"+id+" order by f_date) a where contents Like '%"+keyword+"%'");
          }
        } // search While end
      } // RS check End
    } catch (Exception e) {System.out.println(e);} // try-catch End
